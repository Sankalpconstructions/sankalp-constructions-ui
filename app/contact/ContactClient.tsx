  ...
  return (
    <main className="min-h-screen bg-white">
            ...
            <div className="lg:w-1/3 flex flex-col gap-6">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="bg-white p-8 shadow-xl rounded-2xl border-t-4 border-[#711113]">
                ...
                <p className="text-gray-600 font-light leading-relaxed">
                  12th Floor, Sankalp Tower, Next to IT Park,<br/>
      ...
      <section className="w-full h-96 relative bg-gray-200 border-t border-gray-300">
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2" 
          width="100%" 
          height="100%" 
          style={{ border: 0 }} 
          allowFullScreen 
