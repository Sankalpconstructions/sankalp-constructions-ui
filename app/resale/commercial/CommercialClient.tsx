...
export default function CommercialClient() {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      ...
      try {
        ...
        const res = await fetch(`${baseUrl}/api/resale?type=commercial`);
        ...
        console.error("Failed to fetch commercial resale properties:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="bg-[#f8f5f0] text-gray-900 min-h-screen">
      <PageBanner
        title={<>Commercial <span className="text-[#29B1D2]">Resale</span></>}
        subtitle="Explore prime commercial spaces available for resale, crafted for success, strategic growth, and business excellence."
      ...
      <div className="container mx-auto px-4 lg:px-8 py-14">
        {loading ? (
          <div className="py-24 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="uppercase tracking-[0.2em] font-bold text-xs text-[#711113]">Loading commercial resale properties...</p>
          </div>
        ) : (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    There are currently no commercial properties listed for resale. Please check back later.
                  </p>
                </div>
              </motion.div>
            )}
