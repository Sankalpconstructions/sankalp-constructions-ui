        ...
        <section id="story" className="py-10 md:py-16 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 lg:px-8 z-10 relative">
            <div className="text-center mb-6 md:mb-12 flex flex-col items-center">
              ...
              <Image src="/assets/Title-decorations.png" alt="Decoration" width={200} height={30} className="w-[150px] md:w-[200px] h-auto object-contain mt-1" unoptimized />
            </div>
            <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12 lg:gap-20 text-gray-900">
              ...
              >
                <div className="relative rounded-lg shadow-2xl w-full h-[280px] md:h-[500px] overflow-hidden">
                  <Image
                    src={story.image}
                    alt={story.subtitle}
                    fill
